...
return [
    ...
    'mall'               => [
        //htt******.com
        'www_url'             => 'http://www.hdyywj.com',
        //htt******.com
        'host_url'             => 'http://adm.hdyywj.com',
        //htt******.com/
        'root_url'             => 'http://adm.hdyywj.com/',
        //htt******.com/public/
        'public_url'           => 'http://adm.hdyywj.com/public/',

        'upload_code'      => 'fe8f23i9f0234krt430fk324024k',//上传密码字符串
        'upload_minute'    => '5',//上传凭证有效时间（分钟）
        'product_class_level'    => '1',//系统应用商品分类级数（分钟）
    ],

    //定时任务相关配置
    'crontab'=> [
        'order_success_limit'      => '20',//判断交易成功天数
        'refund_agree_limit'      => '7',//用户规定时间内未发货则视为放弃限时天数
        'barter_refund_supplier_limit'    => '30',//供应商规定时间内未确认收到退货则系统自动确认限时天数
        'barter_refund_user_limit'    => '7',//用户规定时间内未确认收到换货则系统自动确认限时天数
    ],
    ...
    //express参数
    'express'=> [
        'AppCode'      => 'f4417b9996c9410e821850012665d5b7',//自己的AppCode
    ],
];
